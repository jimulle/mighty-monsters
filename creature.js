mm.factory('creature',['move',function(move){
  ...
  Creature.prototype.learnMove = function(mv) {
    var newmove = move(mv);
    if(this.moves.length < 4) { this.moves.push(newmove); }
    else { this.replaceMove(mv); }
  };

  Creature.prototype.replaceMove = function(mv) {
  ...
  return function(data) {
    var c = Object.create(Creature.prototype);
    c.init(data);
    return c;
  };
